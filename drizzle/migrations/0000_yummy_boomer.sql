...
CREATE INDEX IF NOT EXISTS "posts_siteId_index" ON "posts" USING btree ("siteId");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "posts_userId_index" ON "posts" USING btree ("userId");--> statement-breakpoint
